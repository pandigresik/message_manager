...
class MY_Model extends CI_Model
{
    ...
    protected $defaultOrderColumn = array();
    ...
    private function localizeLabel(){
        foreach($this->form as $k => $v){
            if(isset($v['label'])){
                $this->form[$k]['label'] = ucfirst(lang($v['label']));
            }
        }
    }
    ...
    public function getFormOptions($data = null, $where = array())
    {
        ...
        if (!empty($data)) {
            //$tmpLoop = is_array($data) ? $data : $data->getAttributes();
...
SQL;
    ...
    /**
     * Get the value of defaultOrderColumn
     */ 
    ...
    /**
     * Set the value of defaultOrderColumn
     *
     * @return  self
     */ 

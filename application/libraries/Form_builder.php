...
//        }
    ...
    function squish_HTML($html) {
        if($this->getWithoutSquish()) return $html;
            ...
            switch ($this->func) {
                ...
                case 'form_dropdown':
                    ...
                    if (isset($this->elm_options['options']) && !empty($this->elm_options['options'])) {
                        ...
                        $input_html_string = form_dropdown2($name, $options, $value, $this->_create_extra_string());
                    } else {
                        dump($this->elm_options);
    ...
    /**
     * Get the value of withoutSquish
     */ 
    public function getWithoutSquish()
    {
        return $this->withoutSquish;
    }

    /**
     * Set the value of withoutSquish
     *
     * @return  self
     */ 
    public function setWithoutSquish($withoutSquish)
    {
        $this->withoutSquish = $withoutSquish;
